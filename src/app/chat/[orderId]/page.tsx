...
export default function ChatPage({ params }: ChatPageProps) {
  ...
  return (
    <ResponsiveShell mobileActive="chat">
      <section className="border-b border-slate-200 bg-white px-5 py-5 md:px-8">
      ...
      <section className="mx-auto max-w-6xl px-5 py-6 md:px-8 md:py-8">
        <div className="overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-sm">
          ...
          <div className="space-y-4 px-4 py-5 md:space-y-5 md:px-6 md:py-6">
            {messages.length === 0 ? (
              ...
              messages.map((message) => (
                ...
                >
                  <div
                    className={`max-w-[85%] rounded-3xl px-4 py-3 md:max-w-xl md:px-5 md:py-4 ${
          ...
          <div className="border-t border-slate-200 bg-white px-4 py-4 md:px-6 md:py-5">
            <form onSubmit={handleSend} className="flex gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className="rounded-2xl bg-slate-900 px-4 py-3 font-semibold text-white transition hover:bg-slate-800 disabled:opacity-70 md:px-5"
              >
                {loading ? "..." : "Enviar"}
              </button>
            </form>
